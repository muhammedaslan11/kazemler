...
const WebPlan = () => {
    return (
        <>
            <SeoHead title={'Web Plan | KAZEMLER'} />
            <Layout>
                <div className='max-w-5xl lg:mx-auto lg:mr-auto px-4 py-12 md:mx-6 md:mr-6 sm:mx-5 sm:mr-5'>
                    <h1 className='text-4xl font-bold text-center mb-10'>Web Plan</h1>
                    <h3 className='text-left text-2xl mb-3 text-black-600'>What's the Web Plan?</h3>
                    ...
                    <h4 className='text-left text-xl mb-3 text-black-600'>Website Service</h4>
                    ...
                    <div className='flex items-center'>
                        <p className='leading-8 mb-5 text-lg'>
                            ...
                            reasonable. The generated Lorem Ipsum is therefore always Web from repetition, injected humour, or non-characteristic words etc.
                        </p>
                    </div>
                </div>
            </Layout>
