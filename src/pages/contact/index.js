            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2 text-base">
                ...
                <p>
                  ...
                  <a href="tel:+902122223344" className="text-blue-600 hover:underline">
                    +90 532 411 06 64                  </a>
                </p>
                <p>
                  <span className="font-semibold">✉️ E-Mail:</span><br />
                  <a href="mailto:info@kazemler.com" className="text-blue-600 hover:underline">
                    info@kazemler.com
                  </a>
                </p>
              </div>
