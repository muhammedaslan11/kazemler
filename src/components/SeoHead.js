...
const defaultMeta = {
  title: 'KAZEMLER - İhracat, İç Dış Ticaret, Üretici ve Tedarikçi',
  siteName: 'KAZEMLER',
  description:
    'KAZEMLER, ihracat, iç ve dış ticaret, üretim ve tedarik alanlarında faaliyet gösteren lider bir firmadır. Güvenilir çözümler ve kaliteli hizmetler sunuyoruz.',
  url: 'https://www.kazemler.com/',
  type: 'website',
  robots: 'follow, index',
  image: '/public/images/kazemler_logo.png',
  author: ''
};
