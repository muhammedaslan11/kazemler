...
const Button = ({ children, href, type = "outline", className = "" }) => {
    ...
    const baseClass =
        type === "primary"
            ...
            : "font-medium tracking-wide py-2 px-5 sm:px-8 border border-white text-white bg-transparent rounded-full capitalize hover:bg-white hover:text-black hover:shadow-lg";
